...
export default async function ReportsPage() {
  ...
  const statusTextColor: Record<string, string> = {
    ...
    IN_TRANSIT: "text-sky-600 dark:text-sky-400",
                ...
                return (
                  <div key={s.status} className="flex items-center gap-3 rounded border border-slate-100 px-3 py-2 dark:border-neutral-800">
                    <svg width="48" height="48" viewBox="0 0 100 100" className="shrink-0">
                      <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" strokeWidth="8" className="text-slate-200 dark:text-neutral-700" />
              ...
              {topCarriers.map((c) => {
                ...
                return (
                  <div key={c.name}>
                    ...
                    <div className="mt-0.5 h-2 w-full rounded-full bg-slate-200 dark:bg-neutral-700">
              ...
              {warehouseCapacity.map((w) => {
                ...
                return (
                  <div key={w.warehouse_id}>
                    ...
                    <div className="mt-0.5 h-2.5 w-full rounded-full bg-slate-200 dark:bg-neutral-700">
